...
function Library() {
    ...
    const handleDelete = async (id) => {
        ...
        console.log(id);
        backend.delete(`https://localhost:7119/api/libraries/${id}`, {}, { headers })
            .then((response) => {
    ...
    function renderLibraryTable() {
        ...
        return (
            <div className="table-resposive mt-5">
                    ...
                    <tbody>
                        {libraries.map((library) => (
                            <tr key={library.libraryId}>
                                <th scope="row">{library.libraryId}</th>
                                ...
                                <td>
                                    ...
                                    <button onClick={() => handleDelete(library.libraryId)}>Delete</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
                ...
                <br></br>
                <Link className='d-grid gap-2' to={`/allLibraries/LibCreate`}>
