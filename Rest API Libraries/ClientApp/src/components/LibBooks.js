...
function LibBook() {
    ...
    const handleDelete = (bookid) => {
        ...
        console.log(headers);
        //eslint-disable-next-line
        axios.delete('https://restapilibraries.azurewebsites.net/api/cities/' + id + '/libraries/' + Libid + '/books/' + bookid, { headers });    // NEGALIMA PALIKTI {} TUSCIO!
    ...
    function getBooks() {
        //eslint-disable-next-line
        const url = 'https://restapilibraries.azurewebsites.net/api/cities/' + id + '/libraries/' + Libid + '/books';
